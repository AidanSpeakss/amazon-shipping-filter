...
//wow, whoever wrote this originally must have not known about const lol
...
{ 
	...
	if (anchor !=  undefined)
	{
		...
		{
			console.log(content)
			if (!content.match('Climate Pledge Friendly uses sustainability certifications to highlight products that support our commitment to help preserve the natural world. Time is fleeting.'))
			{
				console.log("got it")
